...
const SIDEBAR: SGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Promosi', href: '/laporan/promosi', arrow: true, roles: ['admin'] },
      { label: 'Komisi', href: '/laporan/komisi', arrow: true, roles: ['admin'] },
      { label: 'Invoice', href: '/laporan/invoice', arrow: true, roles: ['admin'] },
      { label: 'Marketing', href: '/laporan/marketing', arrow: true, roles: ['admin'] },
    ],
  },
  {
